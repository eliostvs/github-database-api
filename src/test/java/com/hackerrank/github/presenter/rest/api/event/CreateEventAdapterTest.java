...
public class CreateEventAdapterTest {
    ...
    public void input() {
        ...
        // When
        Event event = CreateEventAdapter.input(request).getEvent();
    ...
    public void output() {
        ...
        // When
        ResponseEntity<ResponseEntity<Object>> actual = CreateEventAdapter.output(output, httpServletRequest);
