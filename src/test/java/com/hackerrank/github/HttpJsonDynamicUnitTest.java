...
@WebAppConfiguration
public class HttpJsonDynamicUnitTest extends BaseControllerTest {
                                ...
                                switch (method) {
                                    case "POST": {
                                        ...
                                        if (!contentType.equals(MediaType.ALL)) {
                                            try {
                                                ResultActions resultActions = mockMvc.perform(asyncPostRequest(url, body));
                                    ...
                                    case "PUT": {
                                        ...
                                        if (!contentType.equals(MediaType.ALL)) {
                                            try {
                                                ResultActions resultActions = mockMvc.perform(asyncPutRequest(url, body));
                                                MockHttpServletResponse mockResponse = resultActions.andReturn()
                                                        .getResponse();
                                    ...
                                    case "DELETE":
                                        try {
                                            ResultActions resultActions = mockMvc.perform(asyncDeleteRequest(url));
                                            MockHttpServletResponse mockResponse = resultActions.andReturn()
                                                    .getResponse();
                                    ...
                                    case "GET":
                                        try {
                                            ResultActions resultActions = mockMvc.perform(asyncGetRequest(url));
                                            MockHttpServletResponse mockResponse = resultActions.andReturn()
                                                    .getResponse();
